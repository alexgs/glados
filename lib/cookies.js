...
function removeAnonSessionCookie( request:GladosRequest, response:$Response ):void {
    return removeSessionCookie( request, response, COOKIE_NAME.SESSION.ANONYMOUS, COOKIE_OPTIONS.ANONYMOUS, 'anonymous');
}

function removeSecureSessionCookie( request:GladosRequest, response:$Response ):void {
