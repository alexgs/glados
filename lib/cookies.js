...
khyron( gladosCookies, 'removeAnonSessionCookie' ).pre( { type: 'array',
    items: [
        _.merge( {}, types.Glados.Request, { required: [ 'cookies' ] } ),
...
khyron( gladosCookies, 'removeSecureSessionCookie' ).pre( { type: 'array',
    items: [
        _.merge( {}, types.Glados.Request, { required: [ 'cookies' ] } ),
        _.merge( {}, types.Glados.Response, { required: [ 'clearCookie' ] } )
    ]
...
khyron( gladosCookies, 'setAnonSessionCookie' ).pre( { type: 'array',
    items: [
...
khyron( gladosCookies, 'setSecureSessionCookie' ).pre( { type: 'array',
    items: [
        _.merge( {}, types.Glados.Response, { required: [ 'cookie' ] } ),
        types.Glados.CookiePayload
    ]
