...
khyron( gladosCookies, 'configure' )
    .precondition( [
        types.Sodium.Key,
...
khyron( gladosCookies, 'getAnonSessionCookie' )
    .precondition( [
...
function getCookieMiddleware() {
    return function cookieMiddleware( request, response, next ) {
        ...
        // Special processing for our special cookies
...
khyron( gladosCookies, 'getSecureSessionCookie' )
    .precondition( [
        _.merge( {}, types.Glados.Request, { required: [ 'cookies' ] } )
    ] );
...
khyron( gladosCookies, 'hasAnonSessionCookie' )
    .precondition( [
...
khyron( gladosCookies, 'hasSecureSessionCookie' )
    .precondition( [
        types.Glados.Request
    ] );
...
khyron( gladosCookies, 'removeAnonSessionCookie' )
    .precondition( [
        _.merge( {}, types.Glados.Request, { required: [ 'cookies' ] } ),
        _.merge( {}, types.Glados.Response, { required: [ 'clearCookie' ] } )
    ] );
...
khyron( gladosCookies, 'removeSecureSessionCookie' )
    .precondition( [
        _.merge( {}, types.Glados.Request, { required: [ 'cookies' ] } ),
        _.merge( {}, types.Glados.Response, { required: [ 'clearCookie' ] } )
    ] );
...
khyron( gladosCookies, 'setAnonSessionCookie' )
    .precondition( [
        _.merge( {}, types.Glados.Response, { required: [ 'cookie' ] } ),
        types.Glados.CookiePayload
    ] );
...
khyron( gladosCookies, 'setSecureSessionCookie' )
    .precondition( [
        _.merge( {}, types.Glados.Response, { required: [ 'cookie' ] } ),
        types.Glados.CookiePayload
    ] );
