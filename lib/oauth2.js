...
function completeOAuth2( publicKey ) {
    ...
    return function( request, response, next ) {
        ...
        superagent.post( factoryOptions.tokenUrl )
            ...
            .then( jwtToken => jwt.validateClaims( jwtToken, factoryOptions.domain, factoryOptions.clientId ) )
            .then( jwtToken => session.setAnonymousSession( request, response, jwtToken ) )
