    ...
    return function( request, response, next ) {
        ...
        superagent.post( factoryOptions.tokenUrl )
            ...
            .then( ({ sessionId, idToken }) => {
                return session.storeIdToken( sessionId, idToken );
            ...
            .then( ({ idToken }) => {
                ...
                // redirects and same site policy.
                // TODO Implement `session.upgradeAnonSession` and
                // TODO Invoke "upgrade anon session" in the middleware returned from `ensureAuthenticated`
